      ...
      <div className="container">
        <div className="grid auto-cols-fr grid-cols-1 items-center gap-12 md:gap-16 lg:grid-cols-2 lg:gap-20">
          <div className="w-full max-w-md lg:mb-24">
            ...
            <p className="md:text-md">4.9 out of 5 stars from 287 reviews</p>
          </div>
          <Carousel
            ...
            <CarouselContent>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Best barber I've found in the city. Knows exactly what to
                    do without a lot of talk."
                  </blockquote>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Been coming here for two years. Consistent, professional,
                    and they respect your time."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                      <img
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "The fade work is exceptional. This is the place if you care
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "No pretense, no nonsense. Just a good cut and a barber who
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "I've tried everywhere else. This is the only place I trust
                    with my head."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">Chris P.</p>
                      <p>Business owner</p>
                    </div>
                  </div>
                </div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Fast, sharp, and they remember how you like it. That's all
                    that matters."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      <p className="font-semibold">Ryan K.</p>
                      <p>Consultant</p>
                    </div>
                  </div>
                </div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "The barbers here actually listen. You get what you want,
